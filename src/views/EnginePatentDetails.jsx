...
const EnginePatentDetails = () => {
  ...
  return (
    ...
    <div className="p-8 pt-32 min-h-screen">
      <h1 className="text-5xl font-bold mb-4">Patents related to Engine Technologies</h1>
      <input
        type="text"
        placeholder="Search Engine Patents..."
        value={searchTerm}
...
export default EnginePatentDetails;
